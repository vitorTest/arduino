...
byte carRed = 12; // estabelece o semáforo para carros
byte carYellow = 11;
byte carGreen = 10;
byte pedRed = 9; // estabelece o semáforo para pedestres
byte pedGreen = 8;
byte button = 2; // pino do botão
...
void loop(){
  ...
  isso ocorreu */
  if (state == HIGH && (millis() - changeTime) > 5000) {// Chama a função para alterar as luzes
  changeLights();
}
